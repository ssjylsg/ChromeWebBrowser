...
namespace Cef3
{
    ...
    public sealed unsafe partial class CefAllowCertificateErrorCallback : IDisposable
    {
        ...
        internal int AddRef()
        {
            return cef_allow_certificate_error_callback_t.add_ref(_self);
        }
        
        internal int Release()
        {
            return cef_allow_certificate_error_callback_t.release(_self);
        }
        
        internal int RefCt
        {
            get { return cef_allow_certificate_error_callback_t.get_refct(_self); }
        }
