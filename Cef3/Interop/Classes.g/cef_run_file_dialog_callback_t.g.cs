...
namespace Cef3.Interop
{
    ...
    internal unsafe struct cef_run_file_dialog_callback_t
    {
        ...
        #endif
        internal delegate int add_ref_delegate(cef_run_file_dialog_callback_t* self);
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int get_refct_delegate(cef_run_file_dialog_callback_t* self);
