...
namespace Cef3.Interop
{
    ...
    internal unsafe struct cef_v8stack_trace_t
    {
        ...
        #endif
        private delegate int add_ref_delegate(cef_v8stack_trace_t* self);
        ...
        public static int add_ref(cef_v8stack_trace_t* self)
        {
            add_ref_delegate d;
        ...
        public static int get_refct(cef_v8stack_trace_t* self)
        {
