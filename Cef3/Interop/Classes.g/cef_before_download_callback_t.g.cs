...
namespace Cef3.Interop
{
    ...
    internal unsafe struct cef_before_download_callback_t
    {
        ...
        #endif
        private delegate int add_ref_delegate(cef_before_download_callback_t* self);
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate int get_refct_delegate(cef_before_download_callback_t* self);
        ...
        public static int add_ref(cef_before_download_callback_t* self)
        {
            add_ref_delegate d;
        ...
        public static int get_refct(cef_before_download_callback_t* self)
        {
