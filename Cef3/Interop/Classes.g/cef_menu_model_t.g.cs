...
namespace Cef3.Interop
{
    ...
    internal unsafe struct cef_menu_model_t
    {
        ...
        #endif
        private delegate int add_ref_delegate(cef_menu_model_t* self);
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate int get_refct_delegate(cef_menu_model_t* self);
        ...
        public static int add_ref(cef_menu_model_t* self)
        {
            add_ref_delegate d;
        ...
        public static int get_refct(cef_menu_model_t* self)
        {
