...
namespace Cef3.Interop
{
    ...
    internal unsafe struct cef_dialog_handler_t
    {
        ...
        #endif
        internal delegate int add_ref_delegate(cef_dialog_handler_t* self);
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int get_refct_delegate(cef_dialog_handler_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int on_file_dialog_delegate(cef_dialog_handler_t* self, cef_browser_t* browser, CefFileDialogMode mode, cef_string_t* title, cef_string_t* default_file_name, cef_string_list* accept_types, cef_file_dialog_callback_t* callback);
