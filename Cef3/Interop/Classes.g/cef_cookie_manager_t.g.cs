...
namespace Cef3.Interop
{
    ...
    internal unsafe struct cef_cookie_manager_t
    {
        ...
        #endif
        private delegate int add_ref_delegate(cef_cookie_manager_t* self);
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate int get_refct_delegate(cef_cookie_manager_t* self);
        ...
        public static int add_ref(cef_cookie_manager_t* self)
        {
            add_ref_delegate d;
        ...
        public static int get_refct(cef_cookie_manager_t* self)
        {
