...
namespace Sashulin
{
    public partial class ChromeWebBrowser: UserControl
    {
        ...
        public int Initialize()
        {
            ...
            //    argv[0] = "-";
            //}
            argv.Add("--allow-file-access-from-files");
            var mainArgs = new CefMainArgs(argv.ToArray());
            ...
            SystemLog.WriteLine("CefRuntime.ExecuteProcess() returns {0}", exitCode);
            if (exitCode != -1)
                return exitCode;
        ...
        { 
            ...
            stringBuilder.Append(");"); 
            return this.EvaluateScript(stringBuilder.ToString());
        }
        ...
        public Object RegistObject { get; set; }
        ...
        {
            SystemLog.WriteLine("BrowserCreated");
            created = true;
        ...
        {
            SystemLog.WriteLine("BrowserNavigated");
        ...
        {
            SystemLog.WriteLine("OnNavigating");
        ...
        {
            SystemLog.WriteLine("OnDocumentCompleted");
            //
        ...
        {
            SystemLog.WriteLine("OnLoadStart");
        ...
        {
            SystemLog.WriteLine("OnLoadError");
        ...
        {
            SystemLog.WriteLine("OnBeforeDownload");
        ...
        {
            SystemLog.WriteLine("OnNewWindow");
            bool res = false;
